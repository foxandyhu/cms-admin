...
import { VisitorsAreaMapService } from './visitors-area-map.service';
...
export class VisitorsAreaMapComponent implements OnDestroy {
  ...
  constructor(private ecMapService: VisitorsAreaMapService,
