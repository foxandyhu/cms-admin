...
export class ArticleDetailComponent extends BaseComponent implements OnInit {
  ...
  private initArticle() {
    ...
    if (this.article.articleExt.docPath) {
      this.showDocResult.show = true;
      this.showDocResult.text = this.article.articleExt.docPath;
    }
    if (this.article.articleExt.mediaPath) {
      this.showMediaResult.show = true;
      this.showMediaResult.text = this.article.articleExt.mediaPath;
    }
  }
